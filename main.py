...
parser.add_argument(
    ...
    "--model",
    type=str,
    choices=[ "vanilla", "credal", "ensemble", "credal_LJ", "odin", "mahalanobis", "knn", "energy", "gnnsafe", "knn_LJ", "gebm", "frozen", "cagcn", "random_set" ],
    default="vanilla",
...
elif args.model == "random_set":
    train_func = trainers.random_set_train
